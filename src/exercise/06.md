...
I learned that with colocation you put the state lower that you can (closer to
the final components), put in practice the concept from before exercise of
separate contexts. With the first extra credit, the idea is to separate the
contexts and wrap only the components that need them. With the third extra
credit, I learned that I can memoize a component that use a slice of a state.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Performance%20%E2%9A%A1&e=06%3A%20Fix%20%22perf%20death%20by%20a%20thousand%20cuts%22&em=salazar.z.esteban%40gmail.com).
